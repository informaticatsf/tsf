            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header" style="background-color: rgb(70, 126, 187);">
                      <a class="btn btn-sm btn-warning float-right" href="{{ route('cliente.show','0312') }}">Regresar</a>
                    ...
                    <div class="card-body" style="background-color: #d1f4ff;">
                        ...
                        <div class="form-group text-center">
                                ...
                                <a class="btn btn-md btn-danger float-right" href="{{ route('cliente.show','0312') }}">Cancelar</a>
                            </div>
                        {!! Form::close() !!}
                    </div>
                </div>
