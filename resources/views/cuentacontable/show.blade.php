...
<td width="100px">{{$cuentacontable->tipo}}</td>
<td width="100px">{{$cuentacontable->ncuenta}}</td>
...
<a class="btn btn-sm btn-outline-dark" id="masfilas" onclick="agregaFila({{$i}}, '{{$cuentacontable->tipo}}', '{{$cuentacontable->ncuenta}}','{{$cuentacontable->impuesto}}','{{$cuentacontable->tipocuenta}}')">+ Cuenta</a>
</td>
</tr>
...
function agregaFila(pos, txt1, txt2, txt3, txt4)    {
    ...
    const boton = "<button type='submit' class='btn btn-primary'>Guardar</button>";
